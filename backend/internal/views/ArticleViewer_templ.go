...
func ArticleViewer(articles []scraper.Article) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, article := range articles {
			...
			var templ_7745c5c3_Var2 templ.SafeURL = templ.URL(article.URL)
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ArticleViewer.templ`, Line: 11, Col: 72}
			}
